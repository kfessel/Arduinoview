// plotcontainer constructs an object
// that holds data in its store
// and plots it using the flot library
...
function plotcontainer(){
    ...
    var plothelp=function(self){
        ...
        self.doplot = function(){
            if (self.timeout) { //clear self.timeout
        ...
        self.plot=function(){
            if(!self.timeout) self.timeout = setTimeout(function(self){return function(){ self.doplot()}}(self),300);
        }
    }(this)
    this.plote = function() {
        this.datamorph=this.enumdata
